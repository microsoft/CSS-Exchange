...
$outputFileStem = ConvertTo-RbaFileNameStem -Value $Identity
$SummaryFilename = "RBA-Summary-For_$outputFileStem`_$runTimestamp.txt"
$JsonFilename = "RBA-Summary-For_$outputFileStem`_$runTimestamp.json"
