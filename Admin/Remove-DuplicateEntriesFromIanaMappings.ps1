...
begin {
    ...
    $scriptBlock = {
        ...
        . $PSScriptRoot\..\Diagnostics\HealthChecker\Analyzer\Test-IanaTimeZoneMapping.ps1
    ...
    foreach ($srv in $Server) {
        ...
        if ($null -ne $exchangeFileVersionInfo -and
            (-not([System.String]::IsNullOrEmpty($exchangeFileVersionInfo)))) {
