...
Function Test-EASBearer {
    process {
        try {
            ...
            $webResponse = Invoke-RestMethod -Uri $requestURI -Headers $headers -Method Get
        }
        catch [System.Net.Sockets.SocketException] {
            Write-Host
...
Function Get-AccessToken {
    process {
        try {
            ...
            $userIdentifierType = [Microsoft.IdentityModel.Clients.ActiveDirectory.UserIdentifierType]::OptionalDisplayableId
