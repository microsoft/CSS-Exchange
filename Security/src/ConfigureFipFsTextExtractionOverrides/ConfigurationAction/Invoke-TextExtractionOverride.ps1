...
function Invoke-TextExtractionOverride {
    ...
    begin {
        $remoteScriptBlockExecute = {
            ...
            # TODO Add a return object here to better process
        }
    }
    process {
        Invoke-Command -ComputerName $ComputerName -ScriptBlock $remoteScriptBlockExecute -ArgumentList ([PSCustomObject]@{
