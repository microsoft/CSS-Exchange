...
#
#################################################################################
[Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSAvoidUsingInvokeExpression', '', Justification = 'Not using input to execute')]
[Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '', Justification = 'Names are being used correctly')]
[Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSAvoidUsingEmptyCatchBlock', '', Justification = 'Allowing empty catch blocks for now.')]
...
#Function runs against the selected database to see if the copies of mailbox database are in healthy state.
function copyStatus {
...
function Write-Start3rdPartyBackup {
    Get-Date
