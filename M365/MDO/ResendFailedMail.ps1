...
$failedMessages = New-Object System.Collections.Generic.List[object]

try {
    $failedMessages += Get-MessageTrace @traceParams
} catch {
...
if (-not $IncludeDuplicates) {
    $uniqueMessages = New-Object System.Collections.Generic.List[object]
    $uniqueMessages += $failedMessages | Sort-Object MessageId -Unique
    $failedMessages = $uniqueMessages
}
