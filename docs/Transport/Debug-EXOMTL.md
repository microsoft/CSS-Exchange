# Debug-EXOMTL
Download the latest release: [Debug-EXOMTL](https://github.com/microsoft/CSS-Exchange/releases/latest/download/Debug-EXOMTL.ps1)
...
## EXAMPLE
``` PowerShell
.\Debug-EXOMTL -MTLPath C:\temp\MyMtl.csv
```
