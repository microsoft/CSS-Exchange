...
```powershell
.\LockAndSavePublicFolderProperties.ps1 -MappingCsv .\map.csv -BackupDir C:\PFToGroupMigration -ArePublicFoldersOnPremises $true -ConnectionUri $connectionUri -AzureADAuthorizationEndpointUri $authorizationEndpointUri
```
