...
To override the Exchange Online endpoints while restoring on-premises public folders, supply the connection and authorization URI values for your environment:

```powershell
.\UnlockAndRestorePublicFolderProperties.ps1 -BackupDir C:\PFToGroupMigration -ArePublicFoldersOnPremises $true -ConnectionUri $connectionUri -AzureADAuthorizationEndpointUri $authorizationEndpointUri
```
