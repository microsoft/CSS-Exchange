...
```powershell
.\Sync-MailPublicFoldersCloudToOnprem.ps1 -CsvSummaryFile .\summary.csv -ConnectionUri $connectionUri -AzureADAuthorizationEndpointUri $authorizationEndpointUri
```
