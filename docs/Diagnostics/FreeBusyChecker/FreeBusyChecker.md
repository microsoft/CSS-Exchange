...
- This is a Beta Version. Please double check on any information provided by this script before proceeding to address any changes to your environment. Be advised that there may be incorrect in the provided output.
...
Valid Input Option Parameters:
  ...
  Parameter               : Auth
    Options               : All; DAuth; OAUth; Null
        ...
        Default Value.    : Null. No switch input means the script will collect availability information for the current used method. If OAuth is enabled it will collect OAuth Availability
